...
//    // A list of the names of data record attributes that contain y-values. ykeys: ['duration_in_min'],
//    // Labels for the y-keys -- will be displayed when you hover over the chart
//    xkey: 'workout_date', 
